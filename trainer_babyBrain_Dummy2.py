...
babyFile = open('trainer_babyTrajectory_Dummy2.txt', 'w')
...
while(runSimulation == 1):
    ...
    if (simulationStatus == 'TRAIN'):
        ...
        if episodeTime < 30:
            # dummy action: from "[str:0,0,2]" to "[str:0,-2,0]" to "str[2,0,0]"
            messageToSend = 'MOVE' + ' ' + str(2) + ' ' + str(0) + ' ' + str(0) + ' ' + str(episodeTime)
        else:
